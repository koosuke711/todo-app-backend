...
# ALLOWED_HOSTS: 本番環境のドメイン名またはIPアドレスを指定する必要があります。
...
ROOT_URLCONF = 'todo_practice1.urls'
...
WSGI_APPLICATION = 'todo_practice1.wsgi.application'
...
# 本番環境で静的ファイルを一箇所に集めるためのディレクトリを設定
